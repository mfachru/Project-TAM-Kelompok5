...
public class SewaPerkakasFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        button = (Button) getView().findViewById(R.id.pesanperkakas);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_sewa_perkakas, container, false);
    }
}